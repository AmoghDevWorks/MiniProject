...
const TechnicianSignIn = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Technician login:', formData)
    ...
    <div className="py-10 min-h-fit bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Technician Sign In</h1>
          <p className="text-gray-600">Access the technician dashboard</p>
        </div>
